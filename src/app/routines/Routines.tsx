        ...
        <div className='routines-container' ref={scrollRef}>
            <div className='routines-top'>
                <form className='search-bar'>
                    ...
                    <input className='search-field' type='search' placeholder='Search public routines...'
            ...
            {tabValue === 'public-routines' &&
                <PublicRoutines scrollTop={scrollTop} searchValue={searchValue}/>}
        </div>
    );
};
